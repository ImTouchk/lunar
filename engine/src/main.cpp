...
#   endif
    ...
    try
    {
        ...
        auto vertex_code = CVirtualPath("Default/default_gl.vert").get_bytes();
        auto fragment_code = CVirtualPath("Default/default_gl.frag").get_bytes();
        ...
        {
            { { -1.f, -1.f, -1.f }, { 0.1f, 0.1f, 0.8f }, { 1.f, 0.f } },
            { {  1.f, -1.f, -1.f }, { 0.5f, 0.2f, 0.4f }, { 0.f, 0.f } },
            { {  1.f,  1.f, -1.f }, { 0.2f, 0.3f, 0.2f }, { 0.f, 1.f } },
            { { -1.f,  1.f, -1.f }, { 0.1f, 0.4f, 0.1f }, { 1.f, 1.f } },
            { { -1.f, -1.f,  1.f }, { 0.0f, 0.6f, 0.1f }, { 0.f, 0.f } },
            { {  1.f, -1.f,  1.f }, { 0.0f, 0.8f, 0.5f }, { 1.f, 0.f } },
            { {  1.f,  1.f,  1.f }, { 0.0f, 0.2f, 0.0f }, { 0.f, 1.f } },
            { { -1.f,  1.f,  1.f }, { 0.0f, 0.1f, 0.0f }, { 1.f, 1.f } },
        };
        ...
        while(game_window.is_active())
        {
            ...
            model = glm::rotate(model, rot, glm::vec3(1.f, 1.f, 1.f));
